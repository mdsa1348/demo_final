import 'package:demo/Problems/desies/Acidity/Symptoms.dart';
...
class Acidity extends StatefulWidget {
  const Acidity({super.key});

  @override
  _AcidityState createState() => _AcidityState();
}

class _AcidityState extends State<Acidity> {
                      ...
                      CustomButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const CiditySymptoms(),
                            ),
                          );
                        },
                      ),
