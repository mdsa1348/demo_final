...
// class UserWithLastMessageTime {
//   final QueryDocumentSnapshot user;
//   final String lastMessageTime;

//   UserWithLastMessageTime(this.user, this.lastMessageTime);
// }
...
//       bool chatRoomExists = await _doesChatRoomExist(currentUserId, userId);
...
//   Future<bool> _doesChatRoomExist(
//       String currentUserId, String otherUserId) async {
//     final sortedUserIds = [currentUserId, otherUserId]..sort();
//     String chatRoomId = '${sortedUserIds[0]}_${sortedUserIds[1]}';
...
//   final FirebaseFirestore _firestore = FirebaseFirestore.instance;
//   Set<String> selectedUserIds = Set(); // Updated variable name
...
//             widget.onUsersSelected(selectedUserIds);
